 <link rel="stylesheet" href="css/footer.css" />
	<footer style="position:relative !important;bottom:-25px !important;padding-left:20px;padding-right:20px">
		  <div class="container">
				<div class="row tb-padding">
					...
					<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
						...
						<li><a href="contact.php"> Contact Us</a></li>
                                                                 ...
                                                                 contact@tunng.co<br/>
                                                                 Address- 9thavenue,Wonderboom<br/>
							...
							<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                                            <ul class="footext">
                                                                <li><a href="sitemapb.php"> Site Map</a></li>
	...
	<style>
	ul.footext li {font-size: 12px;font-weight: normal;}
	</style>
...
<!--                share==========================-->
	...
	<!-- The plugin source -->
	<script src="assets/assets/cool-share/plugin.js"></script>
