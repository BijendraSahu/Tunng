...
<body id="widthID" style="overflow-x: none !important;overflow-y: none !important;background: #ffffff !important">
             ...
             if(lenghtpin =='6')
                 {
                       $.ajax({
                        ...
                        { 
                          ...
                          if(lenghtpini=='6'){
                             window.location.replace("member-timeline.php");
                          }else{
...
<div class="col-md-10 col-xs-10">
     ...
     <input type="password" name="passcode" maxlength="6"  class="form-control" id="answer">  
        </div>
