...
<div class="container">
	<div class="row">
		...
		<!-- Form starting from here -->
    		<center>
                     <h4 style="color: #800080;">Member Forgot Password</h4>
			...
			<div class="main" style="padding-bottom:0px">
                ...
                {
                    print "<div class='col-md-12 alert alert-success' style='padding:5px !important'>";
                ...
                ?>
                    ...
                    ?>
                                    ...
                                    <form method="post"  class="form-signin mg-btm" action="controller/forgotpassmember.php" style="margin:auto">
